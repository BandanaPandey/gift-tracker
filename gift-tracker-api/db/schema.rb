...
ActiveRecord::Schema[8.1].define(version: 2026_04_20_073000) do
  ...
  create_table "users", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "default_reminder_days_before", default: 14, null: false
    t.boolean "default_reminder_enabled", default: true, null: false
    t.string "email", null: false
    t.string "name", null: false
    t.string "password_digest", null: false
    t.integer "reminder_feed_window_days", default: 60, null: false
    t.datetime "updated_at", null: false
